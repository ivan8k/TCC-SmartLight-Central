...
{
    proto16_t response_size = make_ok_data_unit(response, (proto8_t*) self_tag, pdu->origin_tag);
...
esp_err_t setup_i2c_power_sensor()
{
    esp_err_t err;
...
esp_err_t read_i2c_ads1115(uint16_t* data, uint8_t confh)
{
    esp_err_t err;
    ...
    i2c_master_write_byte(cmd, confh, I2C_ACK_CHECK_EN);
...
uint16_t read_i2c_power_sensor()
{
    ...
    read_i2c_ads1115(&voltage, ADS1115_CONFH_A0);
    read_i2c_ads1115(&current, ADS1115_CONFH_A1);
